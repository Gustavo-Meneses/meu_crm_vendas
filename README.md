...
Obtenha sua chave no [Mistral AI Console](https://console.mistral.ai/) e configure-a nos **Secrets** do Streamlit Cloud ou no arquivo local `.streamlit/secrets.toml`:
...
* **Sessão:** Os dados permanecem ativos enquanto a aba do navegador estiver aberta.
